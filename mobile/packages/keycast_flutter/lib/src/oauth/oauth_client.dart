  ...
  Future<VerifyPinResult> verifyPin({
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        // A success status with no code is malformed — surface it as a server
        // error rather than claiming success with nothing to exchange.
        return VerifyPinResult.failure(
          VerifyPinError.server,
          description: 'Verification succeeded but no code was returned',
        );
      }
